...
expName = 'crux_code'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/harpertzou/Desktop/crux-bci-9/crux_code_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text="Think of the word that appears on screen. \n\nHead \nFeet\nLeft Arm\nRight Arm \nEyes \n\nPress 'space' to continue",
    font='Baskerville',
...
trials = data.TrialHandler(nReps=20.0, method='random', 
    ...
    trialList=data.importConditions('/Users/harpertzou/Desktop/crux_stimulus_final.csv'),
...
for thisTrial in trials:
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    stimulus_text.setText(conditions)
    ...
    # keep track of which components have finished
    stimulusComponents = [stimulus_text, mouse]
    ...
    while continueRoutine and routineTimer.getTime() < 5.0:
        ...
        if stimulus_text.status == STARTED:
            ...
            if tThisFlipGlobal > stimulus_text.tStartRefresh + 5.0-frameTolerance:
